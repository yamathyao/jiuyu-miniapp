...
> 当前主线已完成小游戏迁移与棋盘核心闭环，并已完成首页入口、分级 UI、双语设置与页眉风格统一。下一阶段优先级转为主体视觉节奏与工具栏样式统一。

当前主线继续包含：首页主体留白节奏、棋盘页工具栏样式统一，以及后续完成页 / 统计页等外围能力的恢复。
...
状态：进行中  
第 1 项“本地存档”已完成。首页入口、难度选择、提示检查分级、独立设置页 / 语言页、双语切换和棋盘页设置入口已完成接入，并要求产品名统一为“方庭九屿”。
当前已完成首页、设置页、语言页与棋盘页头部视觉统一。
